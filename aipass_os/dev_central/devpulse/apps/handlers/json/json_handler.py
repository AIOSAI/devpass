...
#   - v1.1.0 (2026-01-31): Fixed path to aipass_os/dev_central/devpulse
#   - v1.0.0 (2025-11-21): Initial JSON auto-creation system
#
# CODE STANDARDS:
...
DEVPULSE_JSON_DIR = DEVPULSE_ROOT / "devpulse_json"
JSON_TEMPLATES_DIR = DEVPULSE_ROOT / "apps" / "json_templates"
...
def ensure_json_exists(module_name: str, json_type: str) -> bool:
    ...
    DEVPULSE_JSON_DIR.mkdir(parents=True, exist_ok=True)
...
if __name__ == "__main__":
    ...
    console.print(Panel("[bold cyan]JSON HANDLER - Working Implementation (DEVPULSE)[/bold cyan]", expand=False))
    console.print("\n[TESTING] Creating devpulse test JSONs...")

    # Test auto-creation
    log_operation("test_operation", {"test": "data"}, module_name="devpulse_test")
    increment_counter("devpulse_test", "test_counter", 1)
    update_data_metrics("devpulse_test", test_metric="working")

    console.print(f"\nCheck {DEVPULSE_JSON_DIR}/ for created files:")
    console.print("  - devpulse_test_config.json")
    console.print("  - devpulse_test_data.json")
    console.print("  - devpulse_test_log.json")
    console.print()
