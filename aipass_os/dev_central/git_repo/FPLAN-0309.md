# FPLAN-0309 - Design AIPass Git Architecture

**Created**: 2026-02-08
**Branch**: /home/aipass/aipass_os/dev_central/git_repo
**Status**: Active
**Type**: Standard Plan
...
```bash
drone @ai_mail send @dev_central "PRODUCTION STOPPED: FPLAN-0309" "Issue: [description]. Attempted: [what was tried]. Awaiting guidance."
```
...
- [ ] Status email sent to DEV_CENTRAL:
  ```bash
  drone @ai_mail send @dev_central "FPLAN-0309 Complete" "Summary of what was done, any issues, outcomes"
  ```
