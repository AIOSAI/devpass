...
# Constants
DRONE_ROOT = Path.home() / "aipass_core" / "drone"
DRONE_JSON_DIR = DRONE_ROOT / "drone_json"
JSON_TEMPLATES_DIR = DRONE_ROOT / "apps" / "json_templates"
...
if __name__ == "__main__":
    ...
    # Test auto-creation
    log_operation("test_operation", {"test": "data"}, "drone")
    increment_counter("drone", "test_counter", 1)
    update_data_metrics("drone", test_metric="working")

    console.print()
    console.print("[green]Check /home/aipass/aipass_core/drone/drone_json/ for created files:[/green]")
    console.print("  [dim]•[/dim] drone_config.json")
    console.print("  [dim]•[/dim] drone_data.json")
    console.print("  [dim]•[/dim] drone_log.json")
    console.print()
