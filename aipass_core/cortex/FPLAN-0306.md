# FPLAN-0306 - Build Team Template + Apply New Structure
...
```bash
drone @ai_mail send @dev_central "PRODUCTION STOPPED: FPLAN-0306" "Issue: [description]. Attempted: [what was tried]. Awaiting guidance."
```
...
- [ ] Status email sent to DEV_CENTRAL:
  ```bash
  drone @ai_mail send @dev_central "FPLAN-0306 Complete" "Summary of what was done, any issues, outcomes"
  ```
