...
# Constants
BACKUP_SYSTEM_ROOT = Path.home() / "aipass_core" / "backup_system"
BACKUP_JSON_DIR = BACKUP_SYSTEM_ROOT / "backup_system_json"
JSON_TEMPLATES_DIR = BACKUP_SYSTEM_ROOT / "apps" / "json_templates"
...
if __name__ == "__main__":
    ...
    console.print()
    console.print("[green]Check /home/aipass/aipass_core/backup_system/backup_system_json/ for created files:[/green]")
