# FPLAN-0316 - Medic Phase 2 - Per-Branch Mute/Unmute
...
```bash
drone @ai_mail send @dev_central "PRODUCTION STOPPED: FPLAN-0316" "Issue: [description]. Attempted: [what was tried]. Awaiting guidance."
```
...
- [ ] Status email sent to DEV_CENTRAL:
  ```bash
  drone @ai_mail send @dev_central "FPLAN-0316 Complete" "Summary of what was done, any issues, outcomes"
  ```
