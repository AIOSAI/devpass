...
Orchestrates the welcome command for The Commons CLI.
Creates system welcome posts for new branches and provides
onboarding nudges for inactive members.
...
def handle_welcome(args: List[str]) -> bool:
    """
    Handle the 'welcome' command - scan for unwelcomed branches or welcome a specific branch.
