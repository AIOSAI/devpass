...
Orchestrates comment and vote workflows for The Commons CLI.
...
def handle_comment(args: List[str]) -> bool:
    """
    Handle the 'comment' command - add a comment to a post.
...
def handle_vote(args: List[str]) -> bool:
    """
    Handle the 'vote' command - upvote or downvote a post or comment.
