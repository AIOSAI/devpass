...
#   - Uses same detection pattern as ai_mail branch_detection.py
#   - Reads BRANCH_REGISTRY.json for branch lookup
# =============================================

"""
Branch Identity Detection for The Commons

Detects calling branch from PWD using BRANCH_REGISTRY.json.
Same pattern as ai_mail's branch_detection handler.
...
# =============================================================================
# BRANCH DETECTION (same pattern as ai_mail)
# =============================================================================
