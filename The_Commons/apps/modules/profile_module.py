...
Orchestrates profile viewing and editing for The Commons CLI.
...
def handle_profile(args: List[str]) -> bool:
    """
    Handle the 'profile' command - view or edit social profiles.
...
def handle_who(args: List[str]) -> bool:
    """
    Handle the 'who' command - list all agents with brief profile info.
