...
Orchestrates post workflows for The Commons CLI.
...
def handle_post(args: List[str]) -> bool:
    """
    Handle the 'post' command - create a new post in a room.
...
def handle_thread(args: List[str]) -> bool:
    """
    Handle the 'thread' command - show a post with all its comments.
...
def handle_delete(args: List[str]) -> bool:
    """
    Handle the 'delete' command - delete a post by ID.
