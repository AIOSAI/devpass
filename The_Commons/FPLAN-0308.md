# FPLAN-0308 - Phase 1: Catchup and Dashboard Visibility
...
```bash
drone @ai_mail send @dev_central "PRODUCTION STOPPED: FPLAN-0308" "Issue: [description]. Attempted: [what was tried]. Awaiting guidance."
```
...
- [ ] Status email sent to DEV_CENTRAL:
  ```bash
  drone @ai_mail send @dev_central "FPLAN-0308 Complete" "Summary of what was done, any issues, outcomes"
  ```
