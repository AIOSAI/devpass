# FPLAN-0364 - drone_test_with_preprocess

**Created**: 2026-02-19
**Branch**: /home/aipass/aipass_business/vera
**Status**: Active
**Type**: Standard Plan
...
```bash
drone @ai_mail send @dev_central "PRODUCTION STOPPED: FPLAN-0364" "Issue: [description]. Attempted: [what was tried]. Awaiting guidance."
```
...
- [ ] Status email sent to DEV_CENTRAL:
  ```bash
  drone @ai_mail send @dev_central "FPLAN-0364 Complete" "Summary of what was done, any issues, outcomes"
  ```
