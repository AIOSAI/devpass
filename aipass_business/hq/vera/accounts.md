...
| Feature | Status |
|---------|--------|
| GitHub Discussions | Enabled on AIOSAI/AIPass |
| GitHub Projects | Enabled on AIOSAI/AIPass |
| GitHub Actions | Active (CI, publish workflow) |
| Codecov | Not configured (post-launch enhancement, not blocking) |

## Notes
- All accounts use aipass.system@gmail.com as the unified email
- PyPI publishes via GitHub Actions using PYPI_API_TOKEN secret
- Launch content references these handles in posting schedule
